          ...
          {step === 1 && (
             <div className="animated-step">
                ...
                <div className="host-input-group">
                  ...
                  <input type="text" placeholder="Mega Concert 2027" />
                </div>
          ...
          {step === 2 && (
             <div className="animated-step">
                ...
                <div className="host-input-group">
                  ...
                  <input type="text" placeholder="Indira Gandhi Indoor Stadium" />
                </div>
             ...
             <div className="animated-step">
                ...
                <div className="tier-box">
                  ...
                  <div className="split-inputs">
                    <input type="number" placeholder="Capacity (e.g. 5000)" />
          ...
          {step === 4 && (
             <div className="animated-step">
                ...
                <div className="upload-dropzone">
                   ...
                   <p>or click to browse files (1920x1080 recommended)</p>
                </div>
                
                <div className="host-btn-row">
                  <button className="secondary-btn" onClick={() => setStep(3)}>Back</button>
                  <button className="primary-btn publish-btn" onClick={() => alert('Full Event Hosted and Published Successfully!')}>🚀 Publish Event</button>
                </div>
             </div>
          )}
        </div>
